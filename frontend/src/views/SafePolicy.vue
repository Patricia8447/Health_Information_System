<template>
  <div class="container">
    ...
    <br /> <br /> 
    <p>
      <h4>5. Cookies</h4> “Cookies” are small computer files that are transferred to your
      computer's hard drive that contain information such as user ID, user preferences,
      lists of pages visited and activities conducted while browsing the Website. At your
      option, expense and responsibility, you may block cookies or delete cookies from
      your hard drive. However, by disabling cookies, you may not have access to the
      entire set of features of the Sites. Generally, we use “cookies” to customize your
      ...
      these cookies directly to any of your Personal Information you submit while on the
      Sites, however.
    </p>
    <br /> <br /> 
    <p>
      <h4>6. Web Beacons</h4> In limited circumstances we also may use “Web Beacons” to collect
      anonymous, non-personal information about your use of our Sites and the sites of
      selected sponsors and advertisers, and your use of emails, special promotions or
      newsletters we send to you. “Web Beacons” are tiny graphic image files imbedded in a
      web page or email that provide a presence on the web page or email and send back to
      its home server information from the user’s browser. The information collected by
      web beacons allows us to statistically monitor how many people are using the Sites
      and selected sponsors' and advertisers' sites, or opening our emails, and for what
      purposes.
    </p>
    <br /> <br /> 
    <p>
      <h4>7. Website Analytics</h4> We may use third party website analytics services in connection
      with the Sites. These services do not track your browsing habits across websites
      which do not use their services. We are using the information collected from these
      services to find usability problems to make the Sites easier to use. The collected
      data will never identify you or your account. We only record anonymous user
      information.
    </p>
    <br /> <br /> 
    <p>
      <h4>8. Storage</h4> We store all Traffic Data and review postings indefinitely, even after
      “deletion,” and may archive such information elsewhere. We store all Personal
      Information until you request that we modify or delete it, in which case we may
      still wind up retaining some of that information for the reasons described in
      Section 18 below.
    </p>
    <br /> <br /> 
    <p>
    ...
    <br /> <br /> 
    <p>
      <h4>10. Sharing of Information</h4> We share certain categories of information we collect
      from you in the ways described in this Privacy Policy. We may share Demographic Data
      with advertisers and other third parties only on an aggregate (i.e.,
      non-personally-identifiable) basis. We may also share your Contact Data, Demographic
      Data, Insurance Data and Medical Data with Providers you choose to schedule on our
      Website. We also share Personal Information and Traffic Data with our business
      partners who assist us by performing core services (such as hosting, billing,
      fulfillment, or data storage and security) related to our operation of the Website
      and/or by making certain Interactive Tools available to our users. Those business
    ...
    <br /> <br /> 
    <p>
      <h4>11. User Choice</h4> You may choose not to provide us with any Personal Information. In
      such an event, you can still access and use much of the Sites; however you will not
      be able to access and use those portions of the Sites that require your Personal
      Information.
    </p>
    <br /> <br /> 
    <p>
      <h4>12. Confidentiality and Security</h4> Except as otherwise provided in this Privacy
      Policy, we will keep your Personal Information private and will not share it with
    ...
    <br /> <br /> 
    <p>
      <h4>14. Public Information</h4> Any information that you may reveal in a review posting or
      other online discussion or forum is intentionally open to the public and is not in
      any way private. You should think carefully before disclosing any personally
      identifiable information in any public forum. What you have written may be seen
      and/or collected by third parties and may be used by others in ways we are unable to
      control or predict.
    </p>
    <br /> <br /> 
    <p>
      <h4>15. Security</h4> The security of your Personal Information is important to us. We follow
      generally accepted industry standards to protect the Personal Information submitted
      to us, both during transmission and once we receive it. For example, when you enter
      sensitive information on our Sites, we encrypt that information using secure socket
      layer technology (SSL). Although we make good faith efforts to store Personal
      Information in a secure operating environment that is not open to the public, you
      should understand that there is no such thing as complete security, and we do not
      guarantee that there will be no unintended disclosures of your Personal Information.
      If we become aware that your Personal Information has been disclosed in a manner not
      in accordance with this Privacy Policy, we will use reasonable efforts to notify you
      of the nature and extent of the disclosure (to the extent we know that information)
      as soon as reasonably possible and as permitted by law.
    </p>
    <br /> <br /> 
    <p>
      <h4>16. Lost or Stolen Information</h4> You must promptly notify us if your Contact Data is
    ...
    <br /> <br /> 
    <p>
      <h4>17. Updates and Changes to Privacy</h4> Policy We reserve the right, at any time, to add
      to, change, update, or modify this Privacy Policy so please review it frequently. If
      we do, then we will notify you here, as well as by posting a notice on our Website
      and/or by e-mailing you, along with a description of any changes (material or
      otherwise) and, where appropriate, a link to the modified policy so that you can
      review it. In all cases, use of information we collect is subject to the Privacy
    ...
    <p>
      ...
      decide to visit one of these third party websites, we suggest that you read its
      privacy policy.
    </p>
    <br /> <br /> 
    <p>
