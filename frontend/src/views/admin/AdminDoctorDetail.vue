    ...
    <div class="container">
      ...
      >
        ...
        <el-descriptions-item>
          ...
          <div class="my-content">
            <a
              :href="`http://127.0.0.1:3004/img/${alldoctordetails.doc5}`"
              target="_blank"
            >
              Photo</a
            >
          ...
          <div class="my-content">
            <a
              :href="`http://127.0.0.1:3004/img/${alldoctordetails.doc1}`"
              target="_blank"
            >
              Identity Front</a
            >
          ...
          <div class="my-content">
            <a
              :href="`http://127.0.0.1:3004/img/${alldoctordetails.doc2}`"
              target="_blank"
            >
              Identity Back</a
            >
          ...
          <div class="my-content">
            <a
              :href="`http://127.0.0.1:3004/img/${alldoctordetails.doc3}`"
              target="_blank"
            >
              Certification</a
            >
          ...
          <div class="my-content">
            <a
              :href="`http://127.0.0.1:3004/img/${alldoctordetails.doc4}`"
              target="_blank"
            >
              Work Certificate</a
            >
